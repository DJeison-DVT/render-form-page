...
# Install Chromium and required libraries for headless operation with Puppeteer.
...
# Verify that Chromium is installed and accessible.
RUN ls -alh /usr/bin/chromium-browser && \
